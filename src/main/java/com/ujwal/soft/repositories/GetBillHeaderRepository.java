...
*/	
	...
	@Query(value="select h.bill_header_id,h.bill_date,h.cgst_amt,h.company_id,c.comp_name,c.logo,c.email,c.phone_no,c.gstid,c.address,h.cust_id,cust.cust_name,cust.cust_gstn,cust.cust_address,cust.cust_phone,cust.cust_pan,cust.cust_email,cust.cust_veh_no,cust.cust_model_no,cust.cust_regis_no,cust.cust_vin_no,h.igst_amt,h.disc_amt,h.invoice_no,h.loc_id,l.location_name, h.sgst_amt,h.tax_per,h.user_id,u.user_name,h.del_status,h.grand_total,h.remark,h.round_off,h.status,h.tota_tax,h.taxable_amt,h.bill_date_time,h.ex_int1,h.ex_int2,h.ex_float1,h.ex_float2,h.ex_var1,h.ex_var2,h.sale_type from bill_header h,m_user u,m_customer cust,m_company c,m_location l  where h.del_status=0 and h.user_id=u.user_id and cust.cust_id=h.cust_id and c.comp_id=h.company_id and l.location_id=h.loc_id and h.company_id=:compId and h.cust_id=:custId and h.bill_date between :fromDate and :toDate ORDER BY h.invoice_no DESC",nativeQuery=true)
	...
	@Query(value="select h.bill_header_id,h.bill_date,h.cgst_amt,h.company_id,c.comp_name,c.logo,c.email,c.phone_no,c.gstid,c.address,h.cust_id,cust.cust_name,cust.cust_gstn,cust.cust_address,cust.cust_phone,cust.cust_pan,cust.cust_email,cust.cust_veh_no,cust.cust_model_no,cust.cust_regis_no,cust.cust_vin_no,h.igst_amt,h.disc_amt,h.invoice_no,h.loc_id,l.location_name, h.sgst_amt,h.tax_per,h.user_id,u.user_name,h.del_status,h.grand_total,h.remark,h.round_off,h.status,h.tota_tax,h.taxable_amt,h.bill_date_time,h.ex_int1,h.ex_int2,h.ex_float1,h.ex_float2,h.ex_var1,h.ex_var2,h.sale_type from bill_header h,m_user u,m_customer cust,m_company c,m_location l  where h.del_status=0 and h.user_id=u.user_id and cust.cust_id=h.cust_id and c.comp_id=h.company_id and l.location_id=h.loc_id and h.company_id=:compId  and h.bill_date between :fromDate and :toDate ORDER BY h.invoice_no DESC",nativeQuery=true)
