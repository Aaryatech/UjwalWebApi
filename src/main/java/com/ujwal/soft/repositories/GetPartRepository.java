...
{
	@Query(value="select p.part_id,p.part_tax_id,p.part_name,p.part_no,p.part_register_no,p.part_specification,p.part_ro_no,p.part_del_status,p.part_mrp,t.tax_desc,t.tax_id,t.tax_desc,t.igst_per,t.sgst_per,t.cess_per,t.cgst_per,t.hsn_code,u.uom_id,u.uom_name\r\n" + 
			"from m_part p,m_tax,m_uom t\r\n" + 
